...
if( !class_exists( 'YITH_WCWL_UI' ) ) {
    class YITH_WCWL_UI {
        ...
        public static function add_to_wishlist_button( $url, $product_type, $exists ) {   
            ...
            $html .= '<div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;"><span class="feedback">' . __( 'Produto Adicionado!','yit' ) . '</span> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Ir para Quero!', 'yit' ) ) . '</a></div>';
            $html .= '<div class="yith-wcwl-wishlistexistsbrowse ' . ( $exists ? 'show' : 'hide' ) . '" style="display:' . ( $exists ? 'block' : 'none' ) . '"><span class="feedback">' . __( 'O produto já foi adicionado!', 'yit' ) . '</span> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Ir para Quero!', 'yit' ) ) . '</a></div>';
