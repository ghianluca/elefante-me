...
function flatsome_scripts() {
	...
	/* main style */
	wp_enqueue_style( 'flatsome-style', get_stylesheet_uri(), array(), '1.3.1', 'all');	
	...
	wp_enqueue_script( 'flatsome-theme-js', get_template_directory_uri() .'/js/theme.js?v=1.3', array( 'jquery' ), '20120202', true );
