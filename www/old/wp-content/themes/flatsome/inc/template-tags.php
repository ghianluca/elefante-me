                                        ...
                                        if ($_product->exists() && $cart_item['quantity']>0) :  ?>  
                                      	...
                                      	<div class="row mini-cart-item collapse">
                                      		...
                                      		<div class="small-7 columns"><?php 
                                                 ...
                                                 echo '<div class="cart_list_product_quantity"> '.__('Qntd:', 'flatsome').' '.$cart_item['quantity'].'</div>';
...
?>
                                ...
                                ?>
                                    ...
                                    <?php                                        
                                    else: echo '<p class="empty">'.__('Nenhum produto no carrinho.','woocommerce').'</p>'; endif;                                    
                                ?>                                                                        
                                </div><!-- .mini-cart -->
