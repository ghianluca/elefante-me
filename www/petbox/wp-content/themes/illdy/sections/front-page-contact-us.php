			...
			<div class="row">
				<div class="col-sm-12">
					<div class="row" style="margin-bottom: 45px;">
						...
						<!--<p class="entry"><?php echo esc_html( $general_entry ); ?></p>-->
						<div class="box-left" data-customizer="box-left-address-title">
						<p class="box-left">Faça seu pedido!</p></div>
						<div class="box-right"><p class="entry">Se você é uma PETShop entre em contato e confira nossos valores diferenciados!</p></div>
					</div>
						...
						<div class="col-sm-4">
							<div class="contact-us-box">
								...
								<div class="box-right">
									...
									<?php endif; ?>
									<?php if( $phone ): ?>
										<span class="box-right-row" data-customizer="contact-us-phone"><?php _e( 'Fone:', 'illdy' ); ?> <?php echo esc_html( $phone ); ?></span>
									<?php endif; ?>
								</div><!--/.box-right-->
							</div><!--/.contact-us-box-->
						</div><!--/.col-sm-5-->
